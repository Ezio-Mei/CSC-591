...
def main():
    ...
    train_loader_l, train_loader_u, dev_loader, test_loader, num_class = get_dataloader('C:/Users/eziom/OneDrive/桌面/CSC791/SAT-main/test/', config.num_labeled, config.mu, config.task)
    loaders = {
